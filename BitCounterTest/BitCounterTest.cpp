...
namespace BitCounterTest
{
	...
	public:
		...
		TEST_METHOD(TestFindSmallestBlockHi)
		{
			...
			counter.Reset();
			counter.FindSmallestBlock(data, 64, 4);
			Assert::AreEqual(0, counter.GetSmallestBlockHi());
		}
		//
		...
		TEST_METHOD(TestFindFreeBlock)
		{
			BitCounter counter;
			uint8_t data[32] = { 0x00, 0x00, 0x00, 0xfc, 0xff, 0x1f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xfc,
			                     0xff, 0xff, 0x00, 0xfc, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff };
			counter.FindSmallestBlock(data, 32*8, 8);
			Assert::AreEqual(26, counter.GetSmallestBlockHi());
		}
	};
}
